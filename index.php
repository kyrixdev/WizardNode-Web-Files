...
<h1>Bring Your Projects to <span style="color: red;">LIFE</span></h1>
<p class="sub-heading">WizardNode has made it easier for you to transition into the <span style="color: #ed6192;">cloud</span>.</p>
...
<a href="virtual-servers.php" class="card-a">
<div class="card shadow-card">
<img class="card-img-top" src="img/service1.png" alt="Card image cap">
<img class="card-img-top card-img-iin" src="https://www.flaticon.com/svg/static/icons/svg/2426/2426238.svg" alt="Card image cap">
<div class="card-body">
<h5 class="card-title">Virtual Private Server</h5>
<p class="card-text">Starting at 5$/GB</p>
</div>
</div>
</a>
<a href="web-hosting.php" class="card-a">
<div class="card shadow-card">
<img class="card-img-top" src="img/service1.png" alt="Card image cap">
<img class="card-img-top card-img-iin" src="https://www.flaticon.com/svg/static/icons/svg/841/841345.svg" alt="Card image cap">
<div class="card-body">
<h5 class="card-title">Web Hosting</h5>
<p class="card-text">Starting at 3$/Mo</p>
</div>
</div>
</a>
<a href="domains.php" class="card-a">
<div class="card shadow-card">
<img class="card-img-top" src="img/service1.png" alt="Card image cap">
<img class="card-img-top card-img-in" src="https://www.flaticon.com/svg/static/icons/svg/841/841364.svg" alt="Card image cap">
<div class="card-body">
<h5 class="card-title">Domain Names</h5>
<p class="card-text">.Com Domain At $9.93/yr</p>
</div>
</div>
</a>
</div>
...
<service class="features ar-bg">
<h3 class="title">WizardNode Features</h3>
<div class="container-fluid">
<div class="row justify-content-center" style="padding-top: 3rem;">
<div class="col-sm x">
<div class="feature">
<i class="fas fa-shield-alt"></i><h4> DDOS Ptotection </h4>
</div>
<div class="feature">
<i class="fas fa-headset"></i><h4> 24/7 Support </h4>
</div>
<div class="feature">
<i class="far fa-check-circle"></i><h4> 99% Uptime </h4>
</div>
</div>
<div class="col-sm">
<img src="img/features-logo.png" class="feature-img">
</div>
<div class="col-sm x" style="">
<div class="feature-right">
<i class="fas fa-microchip f-f"></i><h6> Ryzen Processing Power </h6>
</div>
<div class="feature-right">
<i class="fas fa-pager"></i><h5> Custom Panel </h5>
</div>
<div class="feature-right">
<i class="fas fa-stopwatch"></i><h5>Instant Setup</h5>
</div>
</div>
</div>
</div>
...
<h2 class="text-center data-text ml-3 font-weight-bold p-color">Entreprise StartUp</h2>
<p class="entreprise-p">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Exercitationem, commodi? Voluptate culpa qui praesentium laboriosam error repudiandae minus iusto deserunt adipisci sequi, ut quam blanditiis inventore aperiam dolor suscipit rem.</p>
</div>
</div>
</service>

<section class="hm-new-sgnup-prc-cta-sec">
<div class="container">
<div class="row">
<div class="col-xs-12 col-md-6">
<article class="hm-new-sgnup-prc-cta-txt">
<h2>Are You Ready To Start?</h2>
<p>Ready to launch your business to the stratosphere (and beyond)!
</p>
</article>
</div>
<div class="col-xs-12 col-md-6">
